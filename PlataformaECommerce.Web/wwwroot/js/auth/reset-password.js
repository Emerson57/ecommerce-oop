(function () {
    ...
    const feedback = form.querySelector("[data-reset-password-feedback]");
    ...
    const minLength = Number(form.dataset.passwordMinLength || 8);
    const maxLength = Number(form.dataset.passwordMaxLength || 100);
    const ruleElements = {
