...
/// <summary>
/// Representa la solicitud de actualización de un producto dentro de la capa de aplicación.
/// </summary>
/// <remarks>
/// Este DTO se utiliza para transportar la información necesaria para modificar
/// un producto existente dentro del sistema, desacoplando la entrada externa
...
public sealed class UpdateProductRequestDto
{
    ...
    /// <summary>
    /// Devuelve una representación resumida de la solicitud de actualización de producto.
    /// </summary>
    /// <returns>Cadena representativa de la solicitud.</returns>
    public override string ToString()
    {
        return $"UpdateProductRequestDto | Id: {Id} | Name: {Name} | Sku: {Sku} | Price: {Currency} {Price:N2} | Stock: {Stock} | Type: {ProductType} | Active: {IsActive}";
    }
