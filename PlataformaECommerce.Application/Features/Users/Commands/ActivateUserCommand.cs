...
/// <summary>
/// Representa el comando de aplicación para activar un usuario existente dentro del sistema.
/// </summary>
/// <remarks>
/// Este comando modela una intención explícita de escritura sobre el sistema,
/// correspondiente al caso de uso de habilitar un usuario para su operación
/// dentro de la plataforma.
///
/// Su propósito es desacoplar la activación del usuario respecto de otras acciones
...
public sealed class ActivateUserCommand
{
    ...
    /// <summary>
    /// Identificador único del usuario que será activado.
    /// </summary>
    ...
    /// <summary>
    /// Identificador del usuario que solicita o ejecuta la activación.
    /// </summary>
    /// <remarks>
    ...
    /// <summary>
    /// Referencia externa opcional asociada al proceso de activación.
    /// </summary>
    /// <remarks>
    ...
    /// <summary>
    /// Motivo funcional o comentario asociado a la activación del usuario.
    /// </summary>
    /// <remarks>
    ...
    /// <summary>
    /// Devuelve una representación resumida del comando de activación de usuario.
    /// </summary>
    /// <returns>Cadena representativa del comando.</returns>
    public override string ToString()
    {
        return $"ActivateUserCommand | UserId: {UserId} | RequestedByUserId: {RequestedByUserId} | Reason: {Reason}";
    }
